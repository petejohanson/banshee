...
LINK_SYSTEM_RUNTIME_REMOTING = -r:System.Runtime.Remoting
...
LINK_DBUS = $(NDESK_DBUS_LIBS) $(NDESK_DBUS_GLIB_LIBS) /define:ENABLE_DBUS
...
REF_BANSHEE_SERVICES = $(LINK_BANSHEE_CORE_DEPS) $(LINK_MONO_MEDIA_DEPS) $(LINK_LASTFM_DEPS) $(LINK_MUSICBRAINZ_DEPS) $(LINK_SYSTEM_RUNTIME_REMOTING)
...
REF_HALIE = $(LINK_BANSHEE_SERVICES_DEPS) $(LINK_BANSHEE_THICKCLIENT_DEPS)
